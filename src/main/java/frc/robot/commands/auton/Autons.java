...
public class Autons {
     ...
     */
    public PathPlannerPath loadPath(PathPosition position, PathPart part, String pieceNum, boolean scoreHigh,
        String data) {
    ...
    public BeakAutonCommand OneBalance(PathPosition position, GamePieceMode preload) {
        PathPlannerPath traj = loadPath(position, PathPart.Bal, "1", true, "");
    ...
    public BeakAutonCommand Acquire(PathPosition position, GamePieceMode mode, String pieces, boolean initialPath,
        ...
        PathPlannerPath traj = loadPath(position, PathPart.Acquire, pieces, scoreHigh, data);
    ...
    public BeakAutonCommand Score(PathPosition position, String pieces, boolean park, String data) {
        PathPlannerPath traj = loadPath(position, PathPart.Score, pieces, false, data);
    ...
    public BeakAutonCommand Balance(PathPosition position, String pieces) {
        PathPlannerPath traj = loadPath(position, PathPart.Bal, pieces, false, "");
    ...
    public BeakAutonCommand TwoQuarterPiecePark(PathPosition position) {
        PathPlannerPath traj = loadPath(position, PathPart.Park, "2.25", false, "");
