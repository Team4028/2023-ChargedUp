...
public class BeakHolonomicDriveController {
     ...
     *
     * @param xController
     *            A PID controller to respond to error in the
     *            field-relative X direction
     * @param yController
     *            A PID controller to respond to error in the
     *            field-relative Y direction
     * @param rotationController
     *            A PID controller to respond to error in rotation
     */
     ...
     * @param referenceState
     *            The desired trajectory state
     * @param auxReferenceState
     *            The desired trajectory state of the auxiliary
     *            trajectory
     * @return The next output of the holonomic drive controller
     */
    public ChassisSpeeds calculate(Pose2d currentPose, PathPlannerState referenceState,
