...
public class BeakLimelight extends SubsystemBase {
     ...
     * 
     * @param height
     *            A {@link TargetHeight} enum containing the desired game.
     */
     ...
     * 
     * @param height
     *            Height of the goal (approx. center of reflective tape), in
     *            inches.
     */
     ...
     * 
     * @param angle
     *            Angle in degrees, from perfectly vertical, of the Limelight. See
     *            Limelight's docs
