...
/** Add your docs here. */
public class QuadraticPIDController {
     ...
     */
    public QuadraticPIDController(double kp, double ki, double kd) {
        this(kp, ki, kd, 0.02);
    }
     ...
     *            The derivative coefficient.
     * @param period
     *            The period between controller updates in seconds. Must be non-zero
     *            and positive.
     */
    public QuadraticPIDController(double kp, double ki, double kd, double period) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
    ...
    public double calculate(double measurement) {
        ...
        return m_kp * (m_positionError * m_positionError) + m_ki * m_totalError + m_kd * m_velocityError;
    }
